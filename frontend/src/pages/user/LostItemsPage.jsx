        ...
        return (
            <div style={{ background:'var(--bg,#f8fafc)', minHeight:'100vh', padding:'2rem 0 4rem' }}>
                <div className="container" style={{ maxWidth:960 }}>
                    <button onClick={() => setSelectedItem(null)} style={{ display:'inline-flex', alignItems:'center', gap:'0.5rem', background:'var(--surface,#fff)', border:'1.5px solid var(--border,#e2e8f0)', borderRadius:10, padding:'0.5rem 1.2rem', fontWeight:600, cursor:'pointer', color:'var(--text,#1e293b)', marginBottom:'1.5rem', fontSize:'0.9rem' }}>
                        ← Back to Lost Items
                    </button>
