  ...
  if (selectedItem) return (
    <div style={{ background:'var(--bg-color,#f8f9fa)', minHeight:'100vh', padding:'2rem 0 4rem' }}>
      <div className="container" style={{ maxWidth:960 }}>
        <button
          onClick={goBack}
          style={{ display:'inline-flex', alignItems:'center', gap:'0.5rem', background:'var(--card-bg,#fff)', border:'1.5px solid var(--border-color,#dee2e6)', borderRadius:10, padding:'0.5rem 1.2rem', fontWeight:600, cursor:'pointer', color:'var(--text-color,#2c3e50)', marginBottom:'1.5rem', fontSize:'0.9rem' }}
        >
          ← Back to Found Items
        </button>
        ...
        <div style={{ background:'var(--card-bg,#fff)', borderRadius:20, overflow:'hidden', boxShadow:'0 8px 32px rgba(0,0,0,.10)', border:'1px solid var(--border-color,#dee2e6)' }}>
          ...
          <div style={{ padding:'2rem' }}>
            ...
            {/* Claim form */}
            {showClaimForm && (
              <div style={{ background:'var(--hover-bg,#f8fafc)', borderRadius:16, padding:'1.5rem', border:'1px solid var(--border-color,#e2e8f0)', marginTop:'0.5rem' }}>
                <h5 style={{ fontWeight:800, color:'var(--text-color,#1e293b)', marginBottom:'1rem' }}>🙋 Submit Your Claim</h5>
                <p style={{ fontSize:'0.83rem', color:'var(--text-muted,#64748b)', marginBottom:'1rem' }}>
                ...
                <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'0.8rem', marginBottom:'0.8rem' }}>
                  <div>
                    ...
                    <input
                      ...
                      style={{ width:'100%', padding:'0.65rem 0.9rem', borderRadius:9, border:'1.5px solid var(--border-color,#e2e8f0)', background:'var(--card-bg,#fff)', color:'var(--text-color,#1e293b)', fontSize:'0.9rem', outline:'none' }}
                    />
                  </div>
                  <div>
                ...
                <div style={{ marginBottom:'1rem' }}>
                  ...
                  <textarea
                    ...
                    style={{ width:'100%', padding:'0.65rem 0.9rem', borderRadius:9, border:'1.5px solid var(--border-color,#e2e8f0)', background:'var(--card-bg,#fff)', color:'var(--text-color,#1e293b)', fontSize:'0.9rem', outline:'none', resize:'vertical', fontFamily:'inherit' }}
                  />
                </div>
            ...
            <div style={{ marginTop:'1.5rem', borderTop:'1px solid var(--border-color,#e2e8f0)', paddingTop:'1rem' }}>
              ...
              <SharePrintBar item={selectedItem} label="Found" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ background:'linear-gradient(135deg,#064e3b 0%,#065f46 40%,#047857 70%,#10b981 100%)', color:'#fff', padding:'3.5rem 0 5rem', position:'relative', overflow:'hidden', marginBottom:0 }}>
        ...
        <div style={{ position:'absolute', bottom:0, left:0, right:0 }}>
          <svg viewBox="0 0 1440 56" fill="none" style={{ display:'block' }}>
            <path d="M0,40 C360,0 1080,56 1440,16 L1440,56 L0,56 Z" fill="var(--bg-color,#f8f9fa)"/>
          </svg>
        </div>
      </div>
